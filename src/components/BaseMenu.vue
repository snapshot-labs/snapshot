...
<template>
  <Menu as="div" class="relative inline-block h-full text-left">
    ...
    >
      <MenuItems
        class="absolute right-0 z-50 mt-2 origin-top-right overflow-hidden rounded-2xl border bg-skin-header-bg shadow-lg"
      >
